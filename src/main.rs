...
fn setup(
    ...
    //         translation: Translation(Vec3::new(0.0, 0.0, 0.9)),
    ...
    commands
        .spawn(SpriteComponents {
            ...
            translation: Translation(Vec3::new(0.0, -50.0, 0.0)),
            sprite: Sprite {
                size: Vec2::new(30.0, 30.0),
            },
            ..Default::default()
...
fn animate_sprite_system(
    ...
    // for (mut timer, mut sprite, mut translation, maindude) in &mut query.iter() {
